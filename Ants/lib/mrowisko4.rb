...
class Mrowka
  ...
  def pomiedzy(a,b,c)
	...
	def face  # zwraca wygląd twarzy mrówki po ostatnim kroku
		@look[@old]
	end
  def move
...
class Frame
  def initialize(w:,h:,f:,b:)
	...
	def col(c,b,t)
		return "\033[48;5;#{@b}m\033[38;5;#{@f}m#{t}\033[0m"
	end
...
class Mrowisko
  ...
  def draw
	...
	def color(c,b,t)
		return "\033[48;5;#{b}m\033[38;5;#{c}m#{t}\033[0m"
	end
  def goto(x,y)
    print "\033[#{y+1};#{x+1}H"
  end
...
ants = default(ARGV[2].to_i,5)
slow = default(ARGV[3].to_i,10)
