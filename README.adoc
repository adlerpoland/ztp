...
Wydrukowaną dokumentację projektu należy oddać do 8.01.2018.
Dokumentacja dostarczona po 8.01.2018 – ocena obniżona.
Niedostarczenie dokumentacji do 16.01.2018 – ocena ndst w pierwszym terminie.
