...
[NOTE]
Zamiast prezentacji projektu można oddać, oczywiście przed upływem terminu,
...
Więcej szczegółów dotyczących projektów opisano w pliku
link:egzamin_template.adoc[egzamin_template].

Pisemmny egzamin poprawkowy z teorii odbędzie się w sesji poprawkowej
