...
Przykładu kodu do refaktoryzacji:

. git@github.com:andersondias/conway-game-of-life-ruby.git[Conway's Game of Life];
  change – użyć biblioteki https://github.com/ruby/curses[Curses]. Zobacz też
  git@github.com:mmozuras/life.git[mmozuras].
