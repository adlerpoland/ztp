...
[IMPORTANT]
====
Plik README należy skonwertować do formatu PDF, wydrukować i dostarczyć przed
wyznaczonym terminem. Jeśli plik jest w formacie
http://asciidoctor.org[Asciidoctor], to do konwersji można użyć programu
_asciidoctor-pdf_ (jest zainstalowany na serwerze Sigma) w taki sposób:
```sh
asciidoctor-pdf README.adoc
```
Oto przykładowy dokument link:egzamin_template.pdf[egzamin_template.pdf]
